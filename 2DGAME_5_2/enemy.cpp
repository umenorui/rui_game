...
HRESULT InitEnemy(void)
{
	...
	{
		//頂点座標の設定
		pVtx[0].pos = D3DXVECTOR3(g_aEnemy[nCountEnemy].pos.x + 500, g_aEnemy[nCountEnemy].pos.y + 100, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(g_aEnemy[nCountEnemy].pos.x + 500, g_aEnemy[nCountEnemy].pos.y - 100, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(g_aEnemy[nCountEnemy].pos.x + 700, g_aEnemy[nCountEnemy].pos.y + 100, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(g_aEnemy[nCountEnemy].pos.x + 700, g_aEnemy[nCountEnemy].pos.y - 100, 0.0f);
...
void UpdateEnemy(void)
{
	...
	for (int nCountEnemy = 0; nCountEnemy < MAX_ENEMYTYPE; nCountEnemy++, pEnemy++)
	{
		...
		{
			//頂点座標の設定
			pVtx[0].pos = D3DXVECTOR3(g_aEnemy[nCountEnemy].pos.x + 300, g_aEnemy[nCountEnemy].pos.y + 100, 0.0f);
			pVtx[1].pos = D3DXVECTOR3(g_aEnemy[nCountEnemy].pos.x + 300, g_aEnemy[nCountEnemy].pos.y - 100, 0.0f);
			pVtx[2].pos = D3DXVECTOR3(g_aEnemy[nCountEnemy].pos.x + 500, g_aEnemy[nCountEnemy].pos.y + 100, 0.0f);
			pVtx[3].pos = D3DXVECTOR3(g_aEnemy[nCountEnemy].pos.x + 500, g_aEnemy[nCountEnemy].pos.y - 100, 0.0f);
...
void SetEnemy(D3DXVECTOR3 pos, int nType)
{
	...
	for (int nCountENEMY = 0; nCountENEMY < MAX_ENEMYTYPE; nCountENEMY++, pEnemy++)
	{
		if (pEnemy->bUse == false)
		{
			...
			//頂点座標の設定
			pVtx[0].pos = D3DXVECTOR3(g_aEnemy[nCountENEMY].pos.x - 100 + (40 * nCountENEMY), g_aEnemy[nCountENEMY].pos.y + 100, 0.0f);
			pVtx[1].pos = D3DXVECTOR3(g_aEnemy[nCountENEMY].pos.x - 100 + (40 * nCountENEMY), g_aEnemy[nCountENEMY].pos.y - 100, 0.0f);
			pVtx[2].pos = D3DXVECTOR3(g_aEnemy[nCountENEMY].pos.x + 100 + (40 * nCountENEMY), g_aEnemy[nCountENEMY].pos.y + 100, 0.0f);
			pVtx[3].pos = D3DXVECTOR3(g_aEnemy[nCountENEMY].pos.x + 100 + (40 * nCountENEMY), g_aEnemy[nCountENEMY].pos.y - 100, 0.0f);
