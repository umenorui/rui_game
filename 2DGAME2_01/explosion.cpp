...
HRESULT InitExplosion(void)
{
	...
	//D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/smook001.png", &g_pTextureExplosion);
...
void UpdateExplosion(void)
{
	...
	for (int nCntExplosion = 0; nCntExplosion < MAX_EXPLOSION; nCntExplosion++, pExplosion++)
	{
		if (pExplosion->bUse == true)
		{
			...
			//頂点座標の設定
			pVtx[0].pos = D3DXVECTOR3(pExplosion[nCntExplosion].pos.x - 25, pExplosion[nCntExplosion].pos.y + 25, 0.0f);
			pVtx[1].pos = D3DXVECTOR3(pExplosion[nCntExplosion].pos.x - 25, pExplosion[nCntExplosion].pos.y - 25, 0.0f);
			pVtx[2].pos = D3DXVECTOR3(pExplosion[nCntExplosion].pos.x + 25, pExplosion[nCntExplosion].pos.y + 25, 0.0f);
			pVtx[3].pos = D3DXVECTOR3(pExplosion[nCntExplosion].pos.x + 25, pExplosion[nCntExplosion].pos.y - 25, 0.0f);
